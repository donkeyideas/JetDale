...
values
  (
    ...
    35,
    22,
    '{demand_analysis,vision,scope,personas,roadmap,tech_stack,risk_register,success_metrics,budget}'::public.artifact_type[],
  ...
  (
    ...
    35,
    20,
    '{demand_analysis,vision,scope,personas,roadmap,risk_register,success_metrics,budget}'::public.artifact_type[],
  ...
  (
    ...
    35,
    20,
    '{demand_analysis,vision,scope,roadmap,risk_register,success_metrics,budget}'::public.artifact_type[],
