...
- **Retention windows for regulated data are NOT flat across record classes.** When a project touches multiple overlapping regulatory regimes (HIPAA + DEA controlled-substance schedules + state pharmacy boards; financial recordkeeping + tax + AML; education FERPA + state student-records statutes; etc.), the budget MUST account for a tiered retention/lifecycle policy — not a single number. Common splits to call out: HIPAA documentation = 6 years; DEA Schedule II-V records = 2-3 years federal, but several states require 5-10 years; state pharmacy boards vary 2-10 years; SEC books = 7 years; state tax records = up to indefinite. If the project mentions controlled substances, narcotics, dispensing, or schedule numbers, recommend a per-record-class retention policy engine in the architecture (not a flat global TTL) and budget for the legal review that maps each record type to its required retention window.
